...
export default function Navbar() {
    ...
    return (
        <nav className="flex filter relative  drop-shadow-xl transparent  h-20 items-center bg-gray-900  ">
            <div className='flex filter  w-screen rounded-full mx-6 px-4 py-4 bg-gradient-to-br from-purple-800 via-purple-900 to-indigo-800'>
                <MobileNav open={open} setOpen={setOpen}/>
                <div className="w-3/12 flex items-center">
                    <a className="text-white text-2xl font-semibold" href="/"> SIMULACION ITE</a>
                </div>
